...
public class ChoiceOptionBuilder(string key, IEnumerable<IBuilder<IChoiceOptionPrototype>> items) : IBuilder<IChoicePrototype>
{
    ...
    public IEnumerable<IBuilder<IChoiceOptionPrototype>> Items { get; } = items;
