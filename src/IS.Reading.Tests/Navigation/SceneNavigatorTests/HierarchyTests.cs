...
public class HierarchyTests
{
    ...
    public async Task Empty()
    {
        ...
        A.CallTo(() => blockNavigator.MoveNextAsync(null, null)).WithAnyArguments().Returns((INode)null);
        A.CallTo(() => blockNavigator.MovePreviousAsync(null, null)).WithAnyArguments().Returns((INode)null);
