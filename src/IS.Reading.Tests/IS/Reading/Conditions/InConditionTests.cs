...
public class InConditionTests
{
    ...
    [InlineData(true, 2, null, 1, 2)]
    [InlineData(false, 4, 1, 2)]
    [InlineData(false, 4)]
    [InlineData(true, "1", "1")]
    [InlineData(true, "2", "1", "2")]
    [InlineData(true, "2", null, "1", "2")]
    ...
    [Theory]
    [InlineData("Delta In ()", "Delta")]
    [InlineData("Alfa In (1)", "Alfa", "1")]
    [InlineData("Beta In (1, 2)", "Beta", "1", "2")]
    [InlineData("Gama In (1, 2, 3)", "Gama", "1", "2", "3")]
    [InlineData("Alfa In (\"1\")", "Alfa", "\"1\"")]
    [InlineData("Beta In (\"1\", \"2\")", "Beta", "\"1\"", "\"2\"")]
    [InlineData("Gama In (\"1\", \"2\", \"3\")", "Gama", "\"1\"", "\"2\"", "\"3\"")]
    [InlineData("Omega In (1, \"2\")", "Omega", "1", "\"2\"")]
